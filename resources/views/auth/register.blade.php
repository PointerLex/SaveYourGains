...
@section('content')
    <div class="min-h-screen bg-black flex flex-col justify-center"
        ...
        <h1 class="text-4xl font-semibold text-center mt-12 relative text-white ">Regístrate</h1>
        <p class="text-center text-base font-thin text-gray-300  mt-2 z-10">¡Únete a nuestra comunidad!</p>

        <form class="max-w-sm mx-auto mt-12 flex flex-col justify-center z-10" method="POST" action="{{ route('register.store') }}"
            novalidate>
            @csrf
            <label for="name" class="block mb-2 text-sm font-semibold text-white">Nombre</label>
            <div class="relative">
            ...
            <label for="surname" class="block mb-2 text-sm text-white font-semibold mt-4">Apellido</label>
            <div class="relative">
            ...
            <label for="email" class="block mb-2 text-sm font-semibold text-white dark:text-white mt-4">Correo
                electrónico</label>
            <div class="relative">
                <div class="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
                    <svg class ="w-5 h-5" viewBox="-2.4 -2.4 28.80 28.80" fill="none" xmlns="http://www.w3.org/2000/svg"
                        stroke="#6b7280">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
            ...
            <button type="submit"
                class="text-white relative bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mb-2 mt-6">Registrarse</button>
