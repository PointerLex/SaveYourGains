...
<div class="min-h-screen bg-black flex items-center justify-center" style="background-image: url('{{ asset('images/home-bg.png') }}'); background-size: cover; background-position: center;">
    ...
    <div class="text-center text-white p-12 z-10">
        ...
        <p class="mt-2 font-light text-lg">No anotar tus entrenamientos puede hacer que realices los mismos ejercicios con<br />
             los mismos pesos y repeticiones, lo que puede llevar a un estancamiento en tus ganancias y progreso.</p>
        <div class="mt-6">
            <a href="{{ route('register') }}" class="inline-block bg-indigo-600 px-5 py-3 rounded shadow-lg font-semibold hover:bg-indigo-700 transition duration-300">¡Registrarse ya!</a>
